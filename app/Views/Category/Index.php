...
<a class="btn btn-primary" href="<?php echo ROOT_PATH."categories/create" ?>">Tạo</a>
...
<table class="table">
    ...
    ?>
        ...
        <tr>
            ...
            <td>
                <a href="<?php echo ROOT_PATH."categories/edit?id=".$value->Id ?>" class="btn btn-warning">Sửa</a>
            </td>
            <td>
                <a onclick="return confirm('xác nhận')" href="<?php echo ROOT_PATH."categories/delete?id=".$value->Id ?>" class="btn btn-danger">Xóa</a>
            </td>
        </tr>
